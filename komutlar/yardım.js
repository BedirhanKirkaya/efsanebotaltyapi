...
exports.run = (client, message, args) => {
    const embed = new Discord.RichEmbed()
        ...
        .addField(`<a:fast_parrot:599310200163401748> » Linkler`, `[Bot Davet Linki](https://discordapp.com/oauth2/authorize?client_id=631793261371064325&scope=bot&permissions=268443710) **|** [Destek Sunucusu](https://discord.gg/2dYT2RZ) **|** [Bota Oy Ver (Vote)](https://discordbots.org/bot/${botid}/vote) **|** [Web Sitesi](https://asistanbott.glitch.me/)`)//websiteniz yoksa  **|** [Web Sitesi]() yeri silebilirsiniz
